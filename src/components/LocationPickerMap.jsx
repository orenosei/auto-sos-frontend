  ...
  return (
    <div className="location-picker-map-shell relative h-64 overflow-hidden rounded-xl border border-gray-200 bg-slate-100">
      ...
      <button
        ...
        disabled={locating}
        className="absolute bottom-3 right-3 z-10 rounded-lg bg-white px-3 py-2 text-xs font-semibold text-blue-600 shadow-sm hover:bg-blue-50 disabled:cursor-not-allowed disabled:opacity-60"
      >
